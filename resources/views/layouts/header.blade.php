...
<a class="navbar-brand ml-5" href="{{route('welcome')}}"><img src="assets/img/UNIVOTE-LOGO.png" style="width:80px;height:80px;" alt="UniVote" /></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav text-uppercase ml-auto mr-5">
      ...
      <li class="nav-item">
      <div class="dropdown">
        <img class="rounded-circle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" style="width:2.2em; height:2.2em;" >
